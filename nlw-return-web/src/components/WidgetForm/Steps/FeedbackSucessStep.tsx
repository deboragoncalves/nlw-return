...
export function FeedbackSucessStep(prop: FeedbackSucessStepProps) {
    return (
        <>
            <WidgetHeader />
            <CloseButton />
            ...
            <div className="flex flex-col items-center justify-center py-10 w-[304px]">
                ...
                <button type="button"
                    ...
                    className="py-2 px-6 mt-6 bg-zinc-800 rounded-md border-transparent text-sm leading-6 hover:bg-zinc-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offtet-brand-500"
                >
                    Quero enviar outro
                </button>
            </div>
