...
const ContainerFeedbackSuccess = tailwind.div`
    flex 
    flex-col 
    items-center 
    justify-center 
...
const TextFeedbackSuccess = tailwind.span`
    text-xl 
    mt-2
`;

const ButtonNewFeedback = tailwind.button`
    py-2 
    px-6 
    mt-6 
    bg-zinc-800 
...
export function FeedbackSuccessStep(prop: FeedbackSuccessStepProps) {
    return (
        <>
            <WidgetHeader />
            <CloseButton />

            <ContainerFeedbackSuccess>
                ...
                <TextFeedbackSuccess>Agradeçemos seu feedback!</TextFeedbackSuccess>

                <ButtonNewFeedback type="button"
                    onClick={prop.restartFeedback}
                >
                    Quero enviar outro
                </ButtonNewFeedback>
            </ContainerFeedbackSuccess>
